...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        AppCenter.start(application, "2511983c-7caf-4a3b-b2e2-ed805eb57afb", Analytics::class.java, Crashes::class.java)
...
//             Crashes.generateTestCrash()
            try {
                ...
                resultTextView.text = "At the current rate of $interestRate%, saving \$$monthly a month by $retirementAge."
            } catch(ex: Exception){
